...
RandomUniform::RandomUniform(System* system, int numberOfDimensions, int numberOfParticles, double interactionSize, double timeStep, int bins, double bucketSize)  :
        InitialState(system) {
