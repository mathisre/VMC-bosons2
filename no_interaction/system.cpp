...
//        cout << "R_new = " << r_new[d] << endl;
    ...
    // Accept
    if (Random::nextDouble() <= psi_new * psi_new / (m_psiOld * m_psiOld)){
        m_psiOld = psi_new;
...
void System::runMetropolisSteps(int numberOfMetropolisSteps) {
    ...
    cout<< "Initial energy = " << getSampler()->getEnergy()<<endl;
...
//        bool acceptedStep = metropolisStepBruteForce();
        ...
        //OneBodyDensity sometimes crashes the program for some reason
//        oneBodyDensity();
...
std::vector<int> System::getHistogram() const
{
    return m_histogram;
}
